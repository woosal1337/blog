...
Raw outputs in `sample-outputs/` (`*__gpt55.txt` are OpenAI). Reproduce: `run-openai.py` (OpenAI) and `scratchpad/ste/run.py` (Claude). Per-model detail: `experiment-results-openai.md`.
