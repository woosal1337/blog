	...
	return (
		<li>
			...
			>
				{children}
				{isActive && (
					<span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-transparent via-green-700 to-transparent dark:from-zinc-400/0 dark:via-green-400/40 dark:to-transparent" />
				)}
			</Link>
		</li>
	);
