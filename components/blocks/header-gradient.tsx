	...
	return (
		<div className="fixed inset-0 mx-0 max-w-none overflow-hidden">
			<div className="absolute left-1/2 top-[-14.5px] ml-[-41.5rem] h-[25rem] w-[80rem] dark:[mask-image:linear-gradient(white,transparent)]">
				<div className="absolute inset-0 bg-gradient-to-r from-green-300 to-green-100 opacity-40 [mask-image:radial-gradient(farthest-side_at_top,white,transparent)] dark:from-green-200/30 dark:to-green-500/30 dark:opacity-100">
					<svg
						aria-hidden="true"
