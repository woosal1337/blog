...
export function StackList({
	...
	return (
		<div className="mt-12">
			...
			<ul
				className="rounded-lg shadow-[rgba(0,_0,_0,_0.15)_0px_20px_40px_-12px] dark:bg-zinc-950 py-2 px-3 ring-2 hover:ring-3 ring-zinc-900/5 dark:ring-zinc-800 transition-all duration-500 hover:ring-zinc-600/20 dark:hover:ring-zinc-700 divide-y mt-4 divide-border border bg-card dark:bg-zinc-900/75">
