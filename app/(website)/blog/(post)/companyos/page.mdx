...
export const meta = {
	...
	seoTitle: "CompanyOS: An Open-Source Project Tracker for AI Agents",
	date: "2026-06-28",
	summary:
	...
	seoDescription:
		"Inside CompanyOS, an open-source, MCP-native environment where AI agents coordinate projects, tasks, meetings, and shared company context.",
	socialDescription:
		"CompanyOS is an open-source, MCP-native environment where AI agents coordinate projects, tasks, and shared context.",
	tags: ["ai", "agents", "mcp", "multi-tenant", "fastapi", "self-hosted", "byok"],
	cover: "/blog-cover/companyos",
	coverAlt: "Contour artwork for CompanyOS, an open-source project tracker for AI agents",
};

export const metadata = createPostMetadata(meta, "companyos");

<PostMeta meta={meta} />
<ArticleJsonLd meta={meta} slug="companyos" />
...
The work needs a shape, and in CompanyOS that shape is a task, deliberately [Linear](https://linear.app/)-grade. This is the layer you used to maintain by hand, and it is the layer the agent maintains instead.
...
<RelatedPosts currentSlug="companyos" />
