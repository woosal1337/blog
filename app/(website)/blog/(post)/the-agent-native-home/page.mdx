...
export const meta = {
	...
	seoTitle: "The Agent-Native Home: Context for AI Coding Agents",
	date: "2026-07-05",
	summary:
	...
	seoDescription:
		"A practical architecture for AI coding agents: one shared AGENTS.md, two symlinks, a small MCP registry, and a disciplined knowledge protocol.",
	socialDescription:
		"A practical AI-agent environment built from one shared memo, two symlinks, a small MCP registry, and fewer moving parts.",
	tags: ["agents", "architecture", "simplicity", "mcp", "workflow"],
	cover: "/blog-cover/the-agent-native-home",
	coverAlt: "Contour artwork for an agent-native AI development environment",
};

export const metadata = createPostMetadata(meta, "the-agent-native-home");

<PostMeta meta={meta} />
<ArticleJsonLd meta={meta} slug="the-agent-native-home" />
...
<RelatedPosts currentSlug="the-agent-native-home" />
