// Ported verbatim from the Contour project (github.com/woosal1337, MIT) so blog
// banners share the exact same deterministic marks. Type a string, get one
// stable topographic mark drawn from the digits of pi. Pure + offline: same
// input always yields the same SVG.
